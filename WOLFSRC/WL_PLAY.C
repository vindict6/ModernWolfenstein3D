...
int			buttonmouse[4]={bt_attack,bt_aim,bt_use,bt_nobutton};
int			buttonjoy[4]={bt_attack,bt_aim,bt_use,bt_run};
...
// curent user input
//
int			controlx,controly,mouseturnx,mouseturny;		// range from -100 to 100 per tic
...
void PollMouseMove (void)
{
	...
	mouseturnx += mousexmove*10/(13-mouseadjustment);
	mouseturny += mouseymove*20/(13-mouseadjustment);
}
